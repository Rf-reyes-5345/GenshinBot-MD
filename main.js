...
mobile: MethodMobile, 
browser: opcion == '1' ? ['GenshinBot-MD', 'Safari', '2.0.0'] : methodCodeQR ? ['GenshinBot-MD', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '110.0.5585.95'],
auth: {
creds: state.creds,
...
console.log(chalk.bgBlack(chalk.bold.redBright("🟢 Comience con el código de país de su número de WhatsApp, ejemplo: +59175409126\n")))
process.exit(0)
}} else {
while (true) {
numeroTelefono = await question(chalk.bgBlack(chalk.bold.yellowBright('🟢 Ingresa el número que sera bot\nPor ejemplo: +59175409126\n')))
...
global.reloadHandler = async function(restatConn) {
 ...
 conn.welcome = '*╭ﾟ♡ﾟ* @subject *ﾟ♡ﾟ*\n┃✎﹏ *BIENVENIDO(A)!!*\n┃✎﹏ @user\n┃✎﹏ *LEA LA DESCRIPCIÓN DEL GRUPO*\n*╰ﾟ･:✿｡･ﾟ♡ﾟʀᴇʏᴇs ᴏғᴄ ﾟ♡ﾟ･｡✿:･ﾟ*\n\n@desc';
    conn.bye = '*╭══════ ⎘『 ♡ 』⎗ ══════╮*\n╏ @user\n╏ *NO LE SABE AL GRUPO, CHAO OJALA LO ATROPELLEN!!* 😸\n*╰══════ ⎘『 ♡ 』⎗ ══════╯*';
