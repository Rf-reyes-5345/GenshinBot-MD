...
const handler = async (m, { conn, args }) => {
   const res = await fetch('https://github.com/Rf-reyes-5345/GenshinBot-MD');
   const json = await res.json();
   let txt = `           *🧸 𝗕𝗼𝘁 - 𝗦𝗰𝗿𝗶𝗽𝘁 📍*\n\n`;
      txt += `◦  *𝐑𝐞𝐩𝐨:* ${json?.name || '🧸 GenshinBot-MD'}\n`;
      ...
      txt += `◦  *Url:* ${json?.html_url || 'https://github.com/Rf-reyes-5345/GenshinBot-MD'}\n\n`;
